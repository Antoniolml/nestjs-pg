...
export class inituser1678904145669 implements MigrationInterface {
    name = 'inituser1678904145669'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tasks_status_enum" AS ENUM('CREATED', 'IN_PROGRESS', 'FINISHED')`);
